...
public interface StatsServerRepository extends JpaRepository<Hit, Long> {
    ...
    List<HitResponseDto> getWithOutUriAllStats(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end);
    ...
    List<HitResponseDto> getWithOutUriUniqueStats(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end);
